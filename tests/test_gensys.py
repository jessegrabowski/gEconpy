import unittest
import numpy as np
from gEconpy.solvers.gensys import qzdiv, qzswitch, split_matrix_on_eigen_stability, determine_n_unstable
...
class GensysComponentTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.A = np.array(
            [[-2.0123 - 0.5490j, -0.1903 - 0.2355j, 0.5456 - 0.0095j, 0.2528 + 0.0204j, -0.6081 - 0.3134j],
             [0.0000 + 0.0000j, -1.7594 + 0.4800j, -0.1374 - 0.1764j, -0.0810 - 0.0883j, 0.7683 + 0.1901j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.9347 - 0.1598j, 0.8522 + 0.0918j, 0.9138 - 0.0331j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.9237 + 0.1579j, -0.4913 + 0.0776j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 1.0847 + 0.0000j]])

        self.B = np.array([[2.2056 + 0.0000j, -0.9085 + 0.3745j, 0.4071 + 0.0283j, 0.3431 - 0.0258j, -1.7238 + 0.3767j],
                           [0.0000 + 0.0000j, 1.9284 + 0.0000j, -0.2346 - 0.1266j, 0.1147 - 0.0997j, -1.2307 + 0.6968j],
                           [0.0000 + 0.0000j, 0.0000 + 0.0000j, 2.4670 + 0.0000j, -2.8122 - 0.3138j, 1.1122 - 0.0005j],
                           [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 2.4382 + 0.0000j, -0.1066 + 0.0908j],
                           [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 1.3904 + 0.0000j]])

        self.Q = np.array(
            [[-0.1666 + 0.0735j, 0.0022 - 0.2391j, 0.8435 + 0.0613j, -0.3592 + 0.0560j, -0.0947 - 0.2308j],
             [-0.2188 + 0.0720j, 0.6445 - 0.0307j, -0.0598 - 0.3103j, -0.1957 + 0.1424j, 0.6101 + 0.0069j],
             [0.8396 + 0.0311j, -0.0092 + 0.0572j, 0.2951 + 0.0018j, 0.1971 + 0.0028j, 0.4030 - 0.0482j],
             [0.3082 + 0.0657j, 0.7069 - 0.0059j, -0.0045 + 0.0239j, 0.0173 + 0.0158j, -0.6311 + 0.0373j],
             [0.3294 + 0.0000j, -0.1530 + 0.0000j, -0.3118 + 0.0000j, -0.8774 + 0.0000j, -0.0323 + 0.0000j]])

        self.Z = np.array(
            [[-0.1455 + 0.1400j, 0.3500 - 0.1150j, -0.7558 + 0.1162j, -0.4753 + 0.0142j, 0.1124 + 0.0000j],
             [-0.2703 + 0.2195j, 0.5617 - 0.2014j, 0.0504 - 0.0363j, 0.3769 + 0.0342j, -0.6129 + 0.0000j],
             [0.7385 + 0.0767j, -0.0557 + 0.3455j, -0.3824 + 0.0224j, 0.1995 + 0.0520j, -0.3701 + 0.0000j],
             [0.0316 + 0.1059j, 0.2219 - 0.0163j, -0.2197 - 0.0343j, 0.6844 + 0.0878j, 0.6425 + 0.0000j],
             [0.4164 + 0.3179j, 0.5690 + 0.1117j, 0.4634 - 0.0201j, -0.3271 - 0.0717j, 0.2491 + 0.0000j]])
    ...
    def test_qzdiv(self):
        ...
        ans_B = np.array(
            [[2.2056 + 0.0000j, -0.9085 + 0.3745j, 0.4071 + 0.0283j, 0.3431 - 0.0258j, -1.7238 + 0.3767j],
             [0.0000 + 0.0000j, 1.9284 + 0.0000j, -0.2346 - 0.1266j, 0.1147 - 0.0997j, -1.2307 + 0.6968j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, 2.4670 + 0.0000j, -2.8122 - 0.3138j, 1.1122 - 0.0005j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 2.4382 + 0.0000j, -0.1066 + 0.0908j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 1.3904 + 0.0000j]]
    ...
    def test_qzswitch(self):
        ...
        ans_A = np.array(
            [[-2.0123 - 0.5490j, -0.1903 - 0.2355j, -0.5258 - 0.1411j, -0.2499 - 0.0580j, -0.6081 - 0.3134j],
             [0.0000 + 0.0000j, -1.7594 + 0.4800j, 0.0831 + 0.2111j, 0.0672 + 0.0914j, 0.7683 + 0.1901j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, -0.9347 - 0.1598j, -0.8522 + 0.0918j, 0.9138 + 0.0331j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 - 0.0000j, -0.9237 + 0.1579j, -0.4914 - 0.0776j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 1.0847 + 0.0000j]]
        )

        ans_B = np.array(
            [[2.2056 + 0.0000j, -0.9085 + 0.3745j, -0.3919 - 0.1646j, -0.3218 + 0.0273j, -1.7238 + 0.3767j],
             [0.0000 + 0.0000j, 1.9284 + 0.0000j, 0.1851 + 0.1505j, -0.1115 + 0.1575j, -1.2307 + 0.6968j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, -2.4670 - 0.0000j, 2.8122 - 0.3138j, 1.1122 + 0.0005j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, -0.0000 + 0.0000j, -2.4382 - 0.0000j, -0.1066 - 0.0908j],
             [0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 0.0000 + 0.0000j, 1.3904 + 0.0000j]]
        )
        ...
        ans_Q = np.array(
            [[-0.1666 + 0.0735j, 0.0022 - 0.2391j, 0.8435 + 0.0613j, -0.3592 + 0.0560j, -0.0947 - 0.2308j],
             [-0.2188 + 0.0720j, 0.6445 - 0.0307j, -0.0598 - 0.3103j, -0.1957 + 0.1424j, 0.6101 + 0.0069j],
             [0.8396 - 0.0311j, -0.0092 - 0.0572j, 0.2951 - 0.0018j, 0.1971 - 0.0028j, 0.4030 + 0.0481j],
             [0.3082 - 0.0657j, 0.7069 + 0.0059j, -0.0045 - 0.0239j, 0.0173 - 0.0158j, -0.6311 - 0.0372j],
             [0.3294 + 0.0000j, -0.1530 + 0.0000j, -0.3118 + 0.0000j, -0.8774 + 0.0000j, -0.0323 + 0.0000j]]
        )

        ans_Z = np.array(
            [[-0.1455 + 0.1400j, 0.3500 - 0.1150j, 0.7558 + 0.1163j, 0.4753 + 0.0142j, 0.1124 + 0.0000j],
             [-0.2703 + 0.2195j, 0.5617 - 0.2014j, -0.0504 - 0.0363j, -0.3769 + 0.0342j, -0.6129 + 0.0000j],
             [0.7385 + 0.0767j, -0.0557 + 0.3455j, 0.3824 + 0.0224j, -0.1995 + 0.0519j, -0.3701 + 0.0000j],
             [0.0316 + 0.1059j, 0.2219 - 0.0163j, 0.2197 - 0.0343j, -0.6844 + 0.0878j, 0.6425 + 0.0000j],
             [0.4164 + 0.3179j, 0.5690 + 0.1117j, -0.4634 - 0.0201j, 0.3271 - 0.0716j, 0.2491 + 0.0000j]]
        )

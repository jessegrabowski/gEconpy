...
from gEconpy.parser.parse_distributions import InverseGammaDistributionParser, INV_GAMMA_SCALE_ALIASES, \
...
class TestInverseGammaDistributionParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.parse_shape_parameter = partial(self.parser._parse_parameter,
